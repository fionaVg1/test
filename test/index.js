...
function customeLoad() {
  return new Promise((resove, reject) => {
    getJSON('./assets/Index.7b758185.js', (text) => {
      let ele2 = document.createElement("script");
      ele2.type = "module";
      ele2.innerHTML = "import obj from './assets/Index.7b758185.js';let sb = Symbol.toStringTag;window.obj = {default:{setup:obj.setup},[sb]:'Module'};";
